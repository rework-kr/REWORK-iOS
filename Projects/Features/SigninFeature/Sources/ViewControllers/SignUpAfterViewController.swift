...
public class SignUpAfterViewController: UIViewController, UINavigationControllerDelegate {
    ...
    public override func viewDidLoad() {
        ...
        self.reactor = SignUpAfterReactor()
        navigationController?.delegate = self
    }
}

extension SignUpAfterViewController {
    func addSubViews() {
...
extension SignUpAfterViewController: View {
    public func bind(reactor: SignUpAfterReactor) {
        bindAction(reactor: reactor)
        bindState(reactor: reactor)
    }
    
    private func bindAction(reactor: SignUpAfterReactor) {
    ...
    private func bindState(reactor: SignUpAfterReactor) {
    }
}
